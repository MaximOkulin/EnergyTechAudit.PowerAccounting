<Query Kind="Program">
  <Connection>
    <ID>4c87a407-7f94-4d92-a9c3-be9f5a4e8424</ID>
    <Persist>true</Persist>
    <Driver>EntityFrameworkDbContext</Driver>
    <CustomAssemblyPath>C:\EnergyTechAudit.PowerAccounting\Main\EnergyTechAudit.PowerAccounting.DataAccess\bin\Debug\EnergyTechAudit.PowerAccounting.DataAccess.dll</CustomAssemblyPath>
...
{	
	...
	private static string _databasePath = @"c:\EnergyTechAudit.PowerAccounting\Main\EnergyTechAudit.PowerAccounting.Database\";
	
	private static string _domainDllPath = @"c:\EnergyTechAudit.PowerAccounting\Main\EnergyTechAudit.PowerAccounting.Domain\bin\Debug\EnergyTechAudit.PowerAccounting.Domain.dll";
	...
	{	
	   ...
	   var targetFolders = new [] { "Core", "Admin", "Business", "Dictionaries" }; 
        ...
        if(entityType != null)
		{
			...
			if(nameAttribute != null)
			{
				var description = nameAttribute.TypedValue.Value;
			   		entityLines.Add(string.Format("({0}, '{2}', '{3}', '{4}'),", ++entityCount, fileNameParts[0], fileNameParts[1], description, fileNameParts[0]));
